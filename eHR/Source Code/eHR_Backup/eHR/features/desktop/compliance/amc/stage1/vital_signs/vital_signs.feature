...
Feature: AMC - Verification of Numerator and Denominator changes - Vital Signs - Stage 1
  ...
  @tc_4191 @tc_help_text
  Scenario: Verification of Help text and Requirement for Vital Signs- Alternate, Height and Weight and Blood Pressure
    When get "requirement" details of "Vital Signs- Alternate" under "core set" for "stage1 ep" as "within report range"
    Then the "requirement" of "Vital Signs- Alternate" under "core set" should be "equal" to "50"
    When get help text of "Vital Signs- Alternate" under "core set" from tooltip
    Then help text for "Vital Signs- Alternate" should be equal to the text
    """
    More than 50 percent of all unique patients seen by the EP have blood pressure (for patients age 3 and over only) and/or height and weight (for all ages) recorded as structured data.
    """

    When get "requirement" details of "Vital Signs - Height and Weight" under "core set" for "stage1 ep" as "within report range"
    Then the "requirement" of "Vital Signs - Height and Weight" under "core set" should be "equal" to "50"
    ...
    When get "requirement" details of "Vital Signs - Blood Pressure" under "core set" for "stage1 ep" as "within report range"
    Then the "requirement" of "Vital Signs - Blood Pressure" under "core set" should be "equal" to "50"
