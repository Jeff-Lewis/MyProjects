  ...
  class MasterPage
    ...
    def verify_clinical_summary
      begin
        ...
        # commented as the Clinical document is not getting downloaded instead its opening in a new pdf window
        ...
        #
        #num_count = 0
        #while !(File.exists?("#{File.expand_path($current_log_dir)}//GetEndOfVisit.pdf"))
        #  sleep 1
        #  num_count += 1
        #  break if num_count > 120
