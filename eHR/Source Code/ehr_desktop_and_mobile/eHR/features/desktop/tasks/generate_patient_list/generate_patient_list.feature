...
Feature: Tasks - Verification of Tasks Scenarios - Generate Patient list
  ...
  Scenario: Verification of Patient list can be created based on patients Sex
    Given a patient list is generated for "Sex" "Male" in "Generate Patient list" page
    Then patient list with "Sex" "Male" should be displayed in "Generate Patient list" page
...
#  @tc_41
#  Scenario: Verification of List of language selection choice for Preferred Language field on Generate Patient List page
  ...
  Scenario: Verification of Generate Patient List associated to the EP based on preferred method of confidential communication
    ...
    When a patient list is generated for "Preferred method of confidential communication" "Secure Messaging" in "Generate Patient list" page
    Then patient list with "Preferred method of confidential communication" "Secure Messaging" should be displayed in "Generate Patient list" page
