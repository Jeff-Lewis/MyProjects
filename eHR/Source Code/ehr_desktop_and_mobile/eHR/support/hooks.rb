...
at_exit do
  ...
  if $parallel_execution_count == 0
    ...
    arr_report_file = $log_env.get_files_absolute_path("test_result", "html", $start_time - 4.minutes)
    ...
    if ["yes", "true"].include?(PERFORMANCE_REPORT.to_s.downcase)
      ...
      arr_report_file = $log_env.get_files_absolute_path("test_result", "json", $start_time - 4.minutes)
